...
client = MongoClient(mongodb_host, mongodb_port, serverSelectionTimeoutMS=30000, username=mongodb_username, password=mongodb_password)  #Configure the connection to the database
